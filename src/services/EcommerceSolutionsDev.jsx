...
export default function EcommerceSolutionsDev() {
    ...
    <main className="flex-grow flex flex-col w-full font-sans bg-white">
      ...
      <section className="w-full bg-[#ececec] pt-32 pb-16 flex items-center justify-center min-h-[350px]">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto flex flex-row items-center gap-8 w769:gap-4 select-none">
          <Image
            src={`${basePath}/img/e-commerce.webp`}
            alt="Ecommerce Solutions Icon"
            width={85}
            height={85}
          ...
          <h1 className="text-left leading-[1.5] uppercase tracking-[1px]">
            <span className="font-sans block text-[38px] w1470:text-[28px] w1281:text-[24px] w769:text-[18px] text-[#181414] font-bold">E-Commerce</span>
            <span className="font-sans block text-[38px] w1470:text-[40px] w1281:text-[34px] w769:text-[24px] text-[#181414] -mt-1 font-medium">Solutions</span>
          </h1>
        </div>
      </section>
      ...
      <div className="w-full bg-white py-6 select-none border-b border-neutral-100">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-2 font-libre font-medium text-[14px] text-[#000] tracking-[1.5px] flex items-center gap-1 select-none">
          ...
          <Image
            ...
            className="w-[10px] h-[10px] object-contain select-none pointer-events-none mx-1"
          />
          <span className="text-[#ff9000] font-medium">E-Commerce Solutions</span>
        </div>
      </div>
      ...
      <section className="w-full bg-white py-20 select-none">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-4 flex flex-col text-center">
          <h2 className="font-sans text-[36px] w769:text-[24px] text-[#16110f] tracking-normal mb-8 leading-snug font-medium">
            <span>A wonderful shopping experience online</span>
            <br className="hidden sm:inline" />
            <span> always brings back the user</span>
          </h2>
          <div className="font-libre text-[#16110f] text-[16px] w769:text-[14px] leading-[1.8] flex flex-col gap-6 font-light mx-auto text-justify md:text-center">
            <p>
              Selecting the right e-commerce platform, simplifying processes, doing a complete systems integration, providing engaging customer experiences and driving conversions, can be an overwhelming experience. This is not an aspect of your business where you can afford to go wrong. We focus on creating beautiful, conversion optimized e-commerce solutions that help brands tell their story, engage with their customers and increase sales.
            </p>
            <p>
              Struggling to grow your business online? Talk to our team today about how we can drive the right traffic, increase sales, create a holistic user experience and increase loyalty for your E-Commerce Website.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* 6. CTA Let's Talk */}
      <ContactSection
        title="Let's Build Your Ecommerce Platform"
        subtitle="Looking for custom Shopify, WooCommerce, or headless shopping architecture? Let's connect over coffee."
        theme="dark"
      />
    </main>
  );
