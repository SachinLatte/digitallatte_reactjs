...
export default function ContentManagementSystems() {
    ...
    <main className="flex-grow flex flex-col w-full font-sans bg-white">
      ...
      <section className="w-full bg-[#ececec] pt-32 pb-16 flex items-center justify-center min-h-[350px]">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto flex flex-row items-center gap-8 w769:gap-4 select-none">
          <Image
            src={`${basePath}/img/cms.webp`}
            alt="Content Management Systems Icon"
            width={85}
            height={85}
          ...
          <h1 className="text-left leading-[1.5] uppercase tracking-[1px]">
            <span className="font-sans block text-[38px] w1470:text-[28px] w1281:text-[24px] w769:text-[18px] text-[#181414] font-bold">Content Management</span>
            <span className="font-sans block text-[38px] w1470:text-[40px] w1281:text-[34px] w769:text-[24px] text-[#181414] -mt-1 font-medium">Systems (CMS)</span>
          </h1>
        </div>
      </section>
      ...
      <div className="w-full bg-white py-6 select-none border-b border-neutral-100">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-2 font-libre font-medium text-[14px] text-[#000] tracking-[1.5px] flex items-center gap-1 select-none">
          ...
          <Image
            ...
            className="w-[10px] h-[10px] object-contain select-none pointer-events-none mx-1"
          />
          <span className="text-[#ff9000] font-medium">Content Management System</span>
        </div>
      </div>
      ...
      <section className="w-full bg-white py-20 select-none">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-4 flex flex-col text-center">
          <h2 className="font-sans text-[36px] w769:text-[24px] text-[#16110f] tracking-normal mb-8 leading-snug font-medium">
            <span>Every Complex Website</span>
            <br className="hidden sm:inline" />
            <span> needs a simple backend!</span>
          </h2>
          <div className="font-libre text-[#16110f] text-[16px] w769:text-[14px] leading-[1.8] flex flex-col gap-6 font-light mx-auto text-justify md:text-center">
            <p>
              Getting your website live is really just the beginning. The task of keeping content up-to-date, adding pages, products or posts and modifying existing content is a job in itself.
            </p>
            <p>
              Content Management Systems (CMS) allow you to easily update your website without the need for any technical knowledge, from any computer with internet access and without installing any software. Update webpage content, change or upload new images, add interactive content such as videos, upload documents, or choose bespoke calls to action.
            </p>
            <p>
              Whether it is PHP, Wordpress, Magento or an Open Source Platform, our Content Management Systems are robust &amp; reliable.
            </p>
            <p>
              Talk to our team of web development experts to find out which content management system is right for you.
            </p>
          </div>
        </div>
      </section>

      {/* 4. Other Development Services Carousel */}
      ...
      {/* 7. CTA Let's Talk */}
      <ContactSection
        title="Let's Build Your CMS"
        subtitle="Looking for custom WordPress, headless CMS, or bespoke admin dashboards? Let's connect over coffee."
        theme="dark"
      />
    </main>
  );
