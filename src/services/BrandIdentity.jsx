...
const recentBrandWork = [
  {
    title: "Tim Hortons Branding",
    src: "/img/digital/social-meida-creatives/full-size/tim-hortons-branding-thumb.webp"
  },
  {
    title: "Kaziranga University Branding",
    src: "/img/digital/social-meida-creatives/full-size/kaziranga-branding-thumb.webp"
  },
  {
    title: "Puneri Paltan Branding",
    src: "/img/digital/social-meida-creatives/full-size/puneri-paltan-branding-thumb.webp"
  },
  {
    title: "PINC",
...
export default function BrandIdentity() {
  ...
  return (
    <main className="flex-grow flex flex-col w-full font-sans bg-white">
      ...
      <section className="w-full bg-[#ececec] pt-32 pb-16 flex items-center justify-center min-h-[350px]">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto flex flex-row items-center gap-8 w769:gap-4 select-none">
          ...
          <h1 className="text-left leading-[1.5] uppercase tracking-[1px]">
            <span className="font-sans block text-[38px] w1470:text-[28px] w1281:text-[24px] w769:text-[18px] text-[#181414] font-bold">Brand</span>
            <span className="font-sans block text-[38px] w1470:text-[40px] w1281:text-[34px] w769:text-[24px] text-[#181414] -mt-1 font-medium">Identity</span>
          </h1>
        </div>
      </section>
      ...
      <div className="w-full bg-white py-6 select-none border-b border-neutral-100">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-2 font-libre font-medium text-[14px] text-[#000] tracking-[1.5px] flex items-center gap-1 select-none">
          ...
          <Image
            ...
            className="w-[10px] h-[10px] object-contain select-none pointer-events-none mx-1"
          />
          <span className="text-[#ff9000] font-medium">Brand Identity</span>
        </div>
      </div>
      ...
      <section className="w-full bg-[#16110f] py-20 px-6 sm:px-12 text-center text-white relative overflow-hidden select-none">
        ...
        <div className="mx-auto relative z-10">
          <p className="font-sans text-[35px] w1281:text-[24px] w769:text-[18px] leading-relaxed tracking-wide text-gray-300 uppercase">
            <span className="font-sans font-bold text-white">Strong, strategic</span>{" "}
            <span className="text-[#ff9000] font-sans font-bold">branding builds</span>
            <br />
            <span>momentum and</span>{" "}
            <span className="text-[#ff9000] font-sans font-bold">growth.</span>
          </p>
        </div>
      </section>

      {/* 5. Recent Work Showcase */}
      ...
      {/* 8. CTA Let's Talk */}
      <ContactSection
        title="Let's Talk Brand Identity"
        subtitle="Looking to define your visual identity, rebrand, or create cohesive brand guidelines? Let's connect over coffee."
        theme="dark"
      />
    </main>
  );
