    ...
    <main className="flex-grow flex flex-col w-full font-sans bg-white">
      ...
      <section className="w-full bg-[#ececec] pt-32 pb-16 flex items-center justify-center min-h-[350px]">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto flex flex-row items-center gap-8 w769:gap-4 select-none">
          <Image
            src={`${basePath}/img/influncer.webp`}
            alt="Influencer & Celebrity Marketing Icon"
            width={85}
            height={85}
          ...
          <h1 className="text-left leading-[1.5] uppercase tracking-[1px]">
            <span className="font-sans block text-[38px] w1470:text-[28px] w1281:text-[24px] w769:text-[18px] text-[#181414] font-medium">Influencer &amp;</span>
            <span className="font-sans block text-[38px] w1470:text-[40px] w1281:text-[34px] w769:text-[24px] text-[#181414] -mt-1 font-bold">Celebrity Campaigns</span>
          </h1>
        </div>
      </section>
      ...
      <div className="w-full bg-white py-6 select-none border-b border-neutral-100">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-2 font-libre font-medium text-[14px] text-[#000] tracking-[1.5px] flex items-center gap-1 select-none">
          ...
          <Image
            ...
            className="w-[10px] h-[10px] object-contain select-none pointer-events-none mx-1"
          />
          <span className="text-[#ff9000] font-medium">Influencer &amp; Celebrity</span>
        </div>
      </div>
      ...
      <section className="w-full bg-white py-20 select-none">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-4 flex flex-col text-center">
          <h2 className="font-sans text-[36px] w769:text-[24px] text-[#16110f] tracking-normal mb-8 leading-snug font-medium">
            <span>Find the right people and</span>
            <br className="hidden sm:inline" />
            <span> do great things together.</span>
          </h2>
          <div className="font-libre text-[#16110f] text-[16px] w769:text-[14px] leading-[1.8] flex flex-col gap-6 font-light mx-auto text-justify md:text-center">
            <p>
              Our extensive network of Instagrammers, YouTubers, bloggers and celebrities can be drawn up to act as brand ambassadors or to review new products or simply to uplift brand sentiment.
            </p>
            <p>
              Not only do we bring in best performing influencers to match your requirements, we also execute and manage the outreach campaigns from start to finish, so that you can focus on what you do best. We deliver influencer marketing campaigns and strategies that inform, engage and entertain.
            </p>
            <p>
              Whether you&apos;re a brand looking to launch a new product, an agency managing multiple campaigns or you&apos;re an influencer looking for your next promotion, register with us today and start your journey here...
            </p>
          </div>
        </div>
      </section>
      ...
      {/* 6. CTA Let's Talk */}
      <ContactSection
        title="Let's Talk Influencer Campaigns"
        subtitle="Looking to collaborate with creators and influencers who align with your brand? Let's connect over coffee."
        theme="dark"
      />
    </main>
  );
