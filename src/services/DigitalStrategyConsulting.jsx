    ...
    <main className="flex-grow flex flex-col w-full font-sans bg-white">
      ...
      <section className="w-full bg-[#ececec] pt-32 pb-16 flex items-center justify-center min-h-[350px]">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto flex flex-row items-center gap-8 w769:gap-4 select-none">
          <Image
            src={`${basePath}/img/digital-stratrgy.webp`}
            alt="Digital Strategy Consulting Icon"
            width={85}
            height={85}
          ...
          <h1 className="text-left leading-[1.5] uppercase tracking-[1px]">
            <span className="font-sans block text-[38px] w1470:text-[28px] w1281:text-[24px] w769:text-[18px] text-[#181414] font-medium">Digital Strategy</span>
            <span className="font-sans block text-[38px] w1470:text-[40px] w1281:text-[34px] w769:text-[24px] text-[#181414] -mt-1 font-bold">Consulting</span>
          </h1>
        </div>
      </section>
      ...
      <div className="w-full bg-white py-6 select-none border-b border-neutral-100">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-2 font-libre font-medium text-[14px] text-[#000] tracking-[1.5px] flex items-center gap-1 select-none">
          ...
          <Image
            ...
            className="w-[10px] h-[10px] object-contain select-none pointer-events-none mx-1"
          />
          <span className="text-[#ff9000] font-medium">Digital Strategy Consulting</span>
        </div>
      </div>
      ...
      <section className="w-full bg-white py-20 select-none">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-4 flex flex-col text-center">
          <h2 className="font-sans text-[36px] w769:text-[24px] text-[#16110f] tracking-normal mb-8 leading-snug font-medium">
            <span>If you bring a knife to a gunfight,</span>
            <br className="hidden sm:inline" />
            <span> it&apos;s going to end badly for you.</span>
          </h2>
          <div className="font-libre text-[#16110f] text-[16px] w769:text-[14px] leading-[1.8] flex flex-col gap-6 font-light mx-auto text-justify md:text-center">
            <p>
              Have an in-house Digital Team? Unable to get the best out of your Digital Agency? Finding it difficult to align your Corporate strategy with your Digital Strategy?
            </p>
            <p>
              In the past, Marketing was simple with a limited set of activities. But it&apos;s a different ball game today. Competition is rife, advertising costs are high, new social media platforms are blooming every year &amp; customers are dispersed, distracted and skeptical.
            </p>
            <p>
              Digital technologies have changed the world as well as the way marketing and business is done today. To keep pace with the changing trends, Digital Strategy Consulting has become essential for all organisations, big &amp; small.
            </p>
            <p>
              Get in touch with us and bring in Digital Experts to redefine and transform your Digital Media Marketing approach.
            </p>
          </div>
        </div>
      </section>
      ...
      {/* 6. CTA Let's Talk */}
      <ContactSection
        title="Let's Talk Digital Strategy"
        subtitle="Ready to redefine and transform your digital growth roadmap? Let's connect over coffee."
        theme="dark"
      />
    </main>
  );
