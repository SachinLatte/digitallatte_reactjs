...
const otherDevelopmentServices = [
  { slug: "website-microsite", title: "Website & Microsite Development", icon: LuGlobe },
  { slug: "mobile-applications", title: "Mobile Apps & Websites", icon: LuSmartphone },
  { slug: "content-management-systems", title: "Content Management Systems (CMS)", icon: LuLayers },
  { slug: "website-maintenance", title: "Website Maintenance & Security", icon: LuShieldCheck },
...
export default function WebsiteMicrosite() {
    ...
    <main className="flex-grow flex flex-col w-full font-sans bg-white">
      ...
      <section className="w-full bg-[#ececec] pt-32 pb-16 flex items-center justify-center min-h-[350px]">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto flex flex-row items-center gap-8 w769:gap-4 select-none">
          <Image
            src={`${basePath}/img/website-development.webp`}
            alt="Website & Microsite Development Icon"
            width={85}
            height={85}
          ...
          <h1 className="text-left leading-[1.5] uppercase tracking-[1px]">
            <span className="font-sans block text-[38px] w1470:text-[28px] w1281:text-[24px] w769:text-[18px] text-[#181414] font-bold">Website &amp; Microsite</span>
            <span className="font-sans block text-[38px] w1470:text-[40px] w1281:text-[34px] w769:text-[24px] text-[#181414] -mt-1 font-medium">Development</span>
          </h1>
        </div>
      </section>
      ...
      <div className="w-full bg-white py-6 select-none border-b border-neutral-100">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-2 font-libre font-medium text-[14px] text-[#000] tracking-[1.5px] flex items-center gap-1 select-none">
          ...
          />
          <Link href="/our-expertise/web-development-services" className="hover:text-[#ff9000] transition-colors">
          ...
          <Image
            ...
            className="w-[10px] h-[10px] object-contain select-none pointer-events-none mx-1"
          />
          <span className="text-[#ff9000] font-medium">Website &amp; Microsite</span>
        </div>
      </div>
      ...
      <section className="w-full bg-white py-20 select-none">
        <div className="w-[75%] w1470:w-[80%] w1281:w-[85%] w1101:w-[90%] w769:w-[92%] mx-auto px-4 flex flex-col text-center">
          ...
          <div className="font-libre text-[#16110f] text-[16px] w769:text-[14px] leading-[1.8] flex flex-col gap-6 font-light mx-auto text-justify md:text-center">
            <p>
              Our team has the coding chops and the designer&apos;s acumen to develop interactive, engaging and aesthetically appealing websites for your brand. By integrating powerful content, with unique creatives and sound technicals, we set new benchmarks.
            </p>
            <p>
              Be it static HTML based websites, database driven E-commerce websites or chic Corporate websites, our creative and tech teams work in close tandem through the project lifecycle, ensuring that the user interface, visual design and technologies function seamlessly and aid the overarching strategy within your digital estate.
            </p>
            <p>
              Our developers are experienced across a variety of platforms &amp; technologies including PHP, Wordpress, Drupal, Woocommerce etc., and can help you conceptualise, architect, and construct virtually anything.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="w-full bg-[#16110f] py-20 px-6 sm:px-12 text-center text-white relative overflow-hidden select-none">
        ...
        <div className="mx-auto relative z-10">
          <p className="font-sans text-[35px] w1281:text-[24px] w769:text-[18px] leading-relaxed tracking-wide text-gray-300 uppercase">
            <span className="font-sans font-bold text-white">Make your</span>{" "}
            <span className="text-[#ff9000] font-sans font-bold">website</span>
            <br />
            <span>your biggest</span>{" "}
            <span className="text-[#ff9000] font-sans font-bold">asset.</span>
          </p>
        </div>
      </section>
      ...
      {/* 6. Other Development Services Carousel */}
      <section className="w-full bg-[#16110f] py-24 select-none overflow-hidden relative">
        <div className="w-[90%] mx-auto px-4 relative">
          <h2 className="font-sans font-bold text-[42px] w769:text-[30px] text-white uppercase tracking-[2px] text-center mb-16">
            <span className="font-sans font-light">Other Development</span> Services
          </h2>
          ...
          <div className="relative w-full flex items-center px-12 w769:px-0">
            ...
            <Swiper
              ...
              className="w-full"
            >
              {otherDevelopmentServices.concat(otherDevelopmentServices).map((service, index) => {
      ...
      <ContactSection
        ...
        subtitle="Have a web application, microsite, or digital product to engineer? Let's connect over coffee."
        theme="dark"
      />
    </main>
  );
